  ...
  return (
    <SidebarWrapper profile={profile}>
      <div style={{ padding: '0 32px' }}>
        ...
        {/* ENCABEZADO */}
        <div style={{ background: 'linear-gradient(135deg, #3D3A8C 0%, #5B58B0 100%)', borderRadius: 14, padding: '24px 32px', marginBottom: 24, minHeight: 88, display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 88 }}>
