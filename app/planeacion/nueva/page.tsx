      ...
      <div style={{ padding: '0 32px' }}>
        ...
        {!generating && !result && (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, alignItems: 'start' }}>
            ...
            <div>
              <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24, marginBottom: 0 }}>
                <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>1 · Datos del proyecto</p>
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Nombre del proyecto *</label>
                <input placeholder="Ej: El agua en nuestra vida" value={form.nombre_proyecto} onChange={e => update('nombre_proyecto', e.target.value)} style={{ display: 'block', width: '100%', padding: '10px 12px', fontSize: 14, borderRadius: 8, border: '1px solid #D8D6F0', boxSizing: 'border-box', marginBottom: 16, background: 'white' } as React.CSSProperties} />
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Situación problema *</label>
                <textarea placeholder="¿Qué situación del entorno motivó este proyecto?" value={form.situacion_problema} onChange={e => update('situacion_problema', e.target.value)} rows={3} style={{ display: 'block', width: '100%', padding: '10px 12px', fontSize: 14, borderRadius: 8, border: '1px solid #D8D6F0', boxSizing: 'border-box', resize: 'vertical', marginBottom: 16, background: 'white' } as React.CSSProperties} />
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Finalidad *</label>
                <textarea ref={finalidadRef} placeholder="¿Qué lograrán los alumnos al concluir este proyecto?" value={form.finalidad} onChange={e => update('finalidad', e.target.value)} rows={3} style={{ display: 'block', width: '100%', padding: '10px 12px', fontSize: 14, borderRadius: 8, border: '1px solid #D8D6F0', boxSizing: 'border-box', resize: 'vertical', marginBottom: 16, background: 'white' } as React.CSSProperties} />
            ...
            {/* COLUMNA DERECHA — Modalidad, CF, Período, Generar */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>

              {/* 2 · Modalidad */}
              <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24 }}>
                <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>2 · Modalidad de trabajo</p>
              ...
              {/* 3 · Campo formativo principal */}
              <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24 }}>
                <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>3 · Campo formativo principal</p>
                <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Campo formativo *</label>
                ...
                {principalCampo && contenidosDisponibles.length > 0 && (
                  <div>
                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 10 }}>
                      Contenidos *
              ...
              {transversales.length > 0 && (
                <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24 }}>
                  <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>Campos transversales sugeridos</p>
              ...
              {ejePrincipal && (
                <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24 }}>
                  <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>{transversales.length > 0 ? '5' : '4'} · Ejes articuladores</p>
              ...
              {/* Período */}
              <div style={{ background: 'white', border: '1px solid #E0DFF5', borderRadius: 12, padding: 24 }}>
                <p style={{ fontSize: 12, fontWeight: 700, color: '#3D3A8C', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16, marginTop: 0 }}>{ejePrincipal ? (transversales.length > 0 ? '6' : '5') : (transversales.length > 0 ? '5' : '4')} · Período de aplicación</p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 12 }}>
                  <div>
                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Fecha de inicio *</label>
                    <input type="date" value={form.fecha_inicio} onChange={e => update('fecha_inicio', e.target.value)} style={{ display: 'block', width: '100%', padding: '10px 12px', fontSize: 14, borderRadius: 8, border: '1px solid #D8D6F0', boxSizing: 'border-box', background: 'white' } as React.CSSProperties} />
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#1A1A2E', marginBottom: 6 }}>Fecha de término *</label>
                    <input type="date" value={form.fecha_fin} onChange={e => update('fecha_fin', e.target.value)} style={{ display: 'block', width: '100%', padding: '10px 12px', fontSize: 14, borderRadius: 8, border: '1px solid #D8D6F0', boxSizing: 'border-box', background: 'white' } as React.CSSProperties} />
                  </div>
                </div>
